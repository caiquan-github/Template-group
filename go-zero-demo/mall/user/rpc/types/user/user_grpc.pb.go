...
func (c *userClient) GetUserName(ctx context.Context, in *IdRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
	err := c.cc.Invoke(ctx, "/user.User/getUserName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserName(context.Context, *IdRequest) (*UserResponse, error)
...
func (UnimplementedUserServer) GetUserName(context.Context, *IdRequest) (*UserResponse, error) {
...
func _User_GetUserName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.User/getUserName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserName(ctx, req.(*IdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
